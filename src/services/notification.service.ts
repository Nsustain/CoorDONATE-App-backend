...
class NotificationService {
    ...
    public createNotification = async (notification:Partial<Notification>) => {
        return await this.notificationRepository.save(this.notificationRepository.create(notification)) as Notification;
    }
    ...
    public markNotificationAsRead = async (userId: string, notificationId: string) => {
    ...
    public markAllNotificationsAsRead = async (userId: string) => {
        ...
        try {
        let notifications = await this.getNotificationsByUserId(userId);
