    ...
    return instance.isGroup
      ? {
          ...
          groupOwner: instance.groupOwner
            ? userSerializer.serialize(instance.groupOwner)
            : '',
          members: instance.members
            ? userSerializer.serializeMany(instance.members)
            : [],
          // messages: instance.messages
          //   ? messageSerializer.serializeMany(instance.messages)
          //   : [],
          lastMessage:
            instance.lastMessage &&
            messageSerializer.serialize(instance.lastMessage),
        }
      : {
          id: instance.id,
          isGroup: instance.isGroup,
